...
/**
 * @ApiResource
 * @ORM\Entity(repositoryClass=DeckChairRepository::class)
...
class DeckChair
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Pair::class, inversedBy="deckChairs")
     * @ORM\JoinColumn(nullable=false)
     */
    private $pair;

    /**
     * @ORM\OneToMany(targetEntity=Booking::class, mappedBy="deckChair")
     */
    private $bookings;

    /**
     * @ORM\ManyToOne(targetEntity=Beach::class, inversedBy="deckChairs")
     * @ORM\JoinColumn(nullable=false)
     */
    private $beach;

    /**
     * @ORM\ManyToOne(targetEntity=Company::class, inversedBy="deckChairs")
     * @ORM\JoinColumn(nullable=false)
     */
    private $company;
    ...
    public function removeBooking(Booking $booking): self
    {
        if ($this->bookings->removeElement($booking)) {
            ...
            if ($booking->getDeckChair() === $this) {
                $booking->setDeckChair(null);
            }
        }
