...
/**
 * @ApiResource
 * @ORM\Entity(repositoryClass=UmbrellaRepository::class)
...
class Umbrella
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Beach::class, inversedBy="umbrellas")
     * @ORM\JoinColumn(nullable=false)
     */
    private $beach;

    /**
     * @ORM\ManyToOne(targetEntity=Company::class, inversedBy="umbrellas")
     * @ORM\JoinColumn(nullable=false)
     */
    private $company;
